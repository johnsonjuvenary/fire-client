      ...
      <div class="calendar-container">
        <div class="text-container">
          <p>
            ...
            reprehenderit impedit corporis qui omnis explicabo sequi repellat
            exercitationem facilis porro similique illo, inventore beatae minus,
            vero doloribus, distinctio et.
          </p>
        </div>
